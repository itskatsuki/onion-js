...
module.exports.run = async (client, message, args) => {
  ...
  .addField(`Fun:`, `\`\`\`${prefix}meme, ${prefix}cleanmeme, ${prefix}8ball, ${prefix}dice, ${prefix}reddit, ${prefix}joke, ${prefix}coinflip, ${prefix}nou, ${prefix}woah, ${prefix}dumbrate, ${prefix}monkey\`\`\``)
